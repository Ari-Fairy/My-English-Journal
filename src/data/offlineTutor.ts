...
export function getOfflineChatTutorReply(
  ...
  // 1. Celebration / Story Response Handling
  ...
  else if (msg.includes("birthday") || msg.includes("party") || msg.includes("день рождения") || msg.includes("праздник") || msg.includes("отмечал") || msg.includes("отпраздновал") || msg.includes("отметил")) {
